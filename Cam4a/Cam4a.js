...
export default class Cam4a extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Inactive", "./Cam4a/costumes/Inactive.png", {
        x: 60,
        y: 40,
      }),
      new Costume("Active", "./Cam4a/costumes/Active.png", { x: 60, y: 40 }),
    ];
  ...
  *whenthisspriteclicked() {
    ...
    this.stage.vars.camera = "East Hall";
  }
