...
export default class Cam2b extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Inactive", "./Cam2b/costumes/Inactive.png", {
        x: 60,
        y: 40,
      }),
      new Costume("Active", "./Cam2b/costumes/Active.png", { x: 60, y: 40 }),
    ];
  ...
  *whenthisspriteclicked() {
    ...
    this.stage.vars.camera = "W. Hall Corner";
  }
