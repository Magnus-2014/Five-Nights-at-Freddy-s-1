...
export default class Cam1b extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Inactive", "./Cam1b/costumes/Inactive.png", {
        x: 60,
        y: 40,
      }),
      new Costume("Active", "./Cam1b/costumes/Active.png", { x: 60, y: 40 }),
    ];
  ...
  *whenthisspriteclicked() {
    ...
    this.stage.vars.camera = "Dining Area";
  }
