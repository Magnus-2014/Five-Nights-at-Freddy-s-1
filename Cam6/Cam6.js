...
export default class Cam6 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Inactive", "./Cam6/costumes/Inactive.png", { x: 60, y: 40 }),
      new Costume("Active", "./Cam6/costumes/Active.png", { x: 60, y: 40 }),
    ];
  ...
  *whenthisspriteclicked() {
    ...
    this.stage.vars.camera = "Kitchen";
  }
