...
export default class Cam1c extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Inactive", "./Cam1c/costumes/Inactive.png", {
        x: 60,
        y: 40,
      }),
      new Costume("Active", "./Cam1c/costumes/Active.png", { x: 60, y: 40 }),
    ];
  ...
  *whenthisspriteclicked() {
    ...
    this.stage.vars.camera = "Pirate Cove";
  }
